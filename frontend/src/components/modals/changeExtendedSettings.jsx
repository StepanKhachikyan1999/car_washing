...
export default function ChangeExtendedSettings({singleDevice}) {
    ...
    return (
        <div>
            <Button className="link" onClick={handleOpen}>{t('ChangeExtendedSettings')}</Button>
            <Modal
                open={open}
                onClose={handleClose}
                ...
                <div className="container_modal">
                    <form onSubmit={editSettings} id="contact"
                        ...
                        <h3>{t('ChangeExtendedSettings')}</h3>
                        <fieldset>
                            <h6>{t('ChangeExtendedSettings')}</h6>
                            <input
